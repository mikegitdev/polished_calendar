import 'package:calendar2/config.dart';
import 'package:calendar2/data2.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        const Center(
          child: Text(
            "Please click the save button after each selection to ensure your calendar updates accordingly.",
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          //color: Colors.amber,
          border: Border.all(color: const Color(0xFFFE3718)),
        ),
        child: Center(
